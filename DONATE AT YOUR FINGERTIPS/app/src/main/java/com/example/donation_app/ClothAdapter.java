...
public class ClothAdapter extends RecyclerView.Adapter<ClothAdapter.ViewHolder> {
    ...
    private ArrayList<Cloth> mList;
    private Context context;

    public ClothAdapter(ArrayList<Cloth> mList, Context context) {
        this.mList = mList;
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        Cloth vacancy1 = mList.get(position);
        ...
        holder.relativeLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(v.getContext(), Clothdetails.class);
