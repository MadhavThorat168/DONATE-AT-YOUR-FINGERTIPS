...
import com.example.donation_app.Showbook
...
class Booklocation : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_booklocation)
        ...
        task.addOnSuccessListener { location ->
            if (location != null) {
                ...
                supportMapFragment!!.getMapAsync { googleMap ->
                    map = googleMap
                    mfire = FirebaseDatabase.getInstance().reference.child("book")
