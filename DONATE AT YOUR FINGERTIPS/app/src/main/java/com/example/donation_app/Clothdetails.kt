...
class Clothdetails : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        Glide.with(this@Clothdetails).load(url).into(image)
        ...
        btnsend.setOnClickListener {
            ...
            smsManager.sendTextMessage("+91$manifacute", null, "New Request from Receiver", null, null)
        }
