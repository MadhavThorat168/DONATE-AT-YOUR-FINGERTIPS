...
class Details : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        Glide.with(this@Details).load(url).into(image)
...
//        txtprice.setText("Price: " + price)
        ...
        btnsend.setOnClickListener {
            ...
            val mDatabaseRef = FirebaseDatabase.getInstance().getReference("food").orderByChild("name").equalTo(name)
...
//                   println(obj)
                        ...
                        val databaseReference = FirebaseDatabase.getInstance().getReference("food").child(key!!)
                        ...
                        databaseReference.child("food").setValue(origin)
